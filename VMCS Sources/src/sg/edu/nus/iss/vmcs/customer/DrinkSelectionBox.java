...
import sg.edu.nus.iss.vmcs.store.IStoreItemIterator;
...
public class DrinkSelectionBox extends Panel{
	...
	public DrinkSelectionBox(TransactionController txCtrl){
		...
		IStoreItemIterator iterator = storeCtrl.getStoreItemIterator(Store.DRINK);
		int i = 0;
		for (iterator.first(); !iterator.is_done(); iterator.next()) { 
			StoreItem storeItem = iterator.current_item();
